                ...
                if st.button("✅ Conferma upload ticket"):
                    ...
                    for _, r in df.iterrows():
                        ...
                        exists = cur.execute("""
                            ...
                            WHERE matricola_manual=? AND descrizione=? AND data_intervento=?
                        """, (matricola, descrizione, data_interv)).fetchone()
                        if exists:
                            dup += 1
                            continue
                        ...
                        cur.execute("""
                            INSERT INTO ticket (
                                matricola, modello, descrizione, fattura, note, data_intervento,
                        ...
                        """, (
                            matricola, modello, descrizione, fattura, note, data_interv,
...
def pagina_stampa_ticket():
    ...
    if ticket_sel:
        ...
        campi_possibili = ["Logo","Tecnico Frigorista" ,"Criticità segnalata","Data previsto intervento", "Data Intervento", "Tipo Guasto", "Intervento svolto", "Note", "Fattura"]
