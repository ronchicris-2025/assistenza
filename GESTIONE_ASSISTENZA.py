...
def mostra_popup_ticket_aperti(df_open):
    ...
    if hasattr(st, "dialog"):
        @st.dialog("⚠️ TICKET APERTI (aperto/lavorazione) (clicca per visualizzare)")
        def _modal():
        ...
        with st.expander("⚠️ Ticket APERTI (aperto/lavorazione) (clicca per visualizzare)", expanded=True):
